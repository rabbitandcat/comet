<template>
    <div class="home-container">
            ...
            <div class="left-container">
                <div class="search-area">
                    <div class="search-bar">
                        <input type="text" class="search-input" placeholder="搜索您的NFT...">
                    </div>
                    <button class="search">
                        <img src="@/assets/svg/zoom.svg" alt="">
                    </button>
                </div>
                <div class="nft-container">
                    <ul class="nft-list">
                        <li class="nft-item">
                            <img src="@/assets/img/NFT3.png" alt="">
                            <p class="nft-name">NFT 1001</p>
                        </li>
                        <li class="nft-item">
                            <img src="@/assets/img/NFT3.png" alt="">
                            <p class="nft-name">NFT 1001</p>
        ...
        <section class="order-page">
            ...
            <div class="right-container">
                <div class="title">
                    <img src="@/assets/svg/shouhuo.svg" alt="">
                    <p>收货信息</p>
                </div>
...
.home-container {
    ...
    .home-page {
        ...
        align-items: center;
        width: 100vw;
        background-image: url('@/assets/img/bg_homepage.png');
